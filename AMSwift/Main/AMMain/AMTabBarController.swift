...
//        print("self.navigationController?.navigationBar.subviews:\(self.navigationController?.navigationBar.subviews)")
    ...
    func addChild(_ childController: AMBaseController, title: String, normalColor:UIColor, selColor:UIColor, norImgName:String, selImgName:String) -> AMNavigationController{
